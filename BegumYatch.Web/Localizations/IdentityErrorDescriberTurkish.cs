...
namespace BegumYatch.Web.Localizations
{
    public class IdentityErrorDescriberTurkish : IdentityErrorDescriber
    {
        ...
        {
            return new() { Code = "PasswordRequiresLower", Description = "Şifre küçük harf içermelidir" };
        }
        public override IdentityError InvalidEmail(string email)
        {
            return new() { Code = "InvalidEmail", Description = $"{email} geçersizdir" };
        }
