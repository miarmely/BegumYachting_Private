...
namespace BegumYatch.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> ForgetPassword(ForgetPasswordViewModel request)
        {
            ...
            await _emailService.SendEmailAsync("Begüm Yatcılık Şifre Yenileme Linki", @$"
                  <h4>Şifrenizi yenilemek için aşağıdaki linkte tıklayınız.</h4>
                  <p><a href='{passwordResetLink}'>şifre yenileme link</a></p>", hasUser.Email!);
