    ...
    spn_eventManager.on("click_article", async (_, event) => {
        await click_articleAsync(
            ...
            async (infosOfLastClickedArticle) => {
                ...
                let transferDate = getDefaultValueIfValueNullOrEmpty(infosOfLastClickedArticle.transferDate);
                ...
                let formInfos = {
                    ...
                    transferDate: (transferDate == infosOfLastClickedArticle.transferDate ?
                        ...
                        : transferDate),  // when date is null or empty
        ...
        await populateArticlesAsync(
            ...
            async (demands) => {
                for (let index in demands) {
                    ...
                    let checkedNotes = getDefaultValueIfValueNullOrEmpty(demandInfos.notes);
                    ...
                    let articleInfos = {
                        ...
                        notes: (checkedNotes == demandInfos.notes ?
                            checkedNotes.substring(0, 200) // when notes is not null or empty
                            : checkedNotes),  // when notes is null or empty                            
