...
$(function () {
    ...
    const inputInfos = [
        ...
        ["input", "text", "excursionDate", "Gezi Tarihi", false, "readonly", [div.formInfos_inputs]],
        ...
        ["input", "text", "firstLanguage", "1. Dil", false, "readonly", [div.formInfos_inputs]],
        ["input", "text", "secondLanguage", "2. Dil", true, "readonly", [div.formInfos_inputs]],
    ...
    btn.accept.click(async () => {
        await acceptTheFormAsync(
            "/adminPanel/demand/excursion/answer",
    ...
    async function setupPageAsync() {
        div.panelTitle.append("GEZİ İSTEĞİ TALEBİ");
